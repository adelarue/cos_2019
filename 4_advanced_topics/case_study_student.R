...
prices_modeled %>% 
	...
	mutate(metric = factor(metric, c('price_per', 'trend', 'periodic', 'remainder'))) %>% 
	ggplot() + 
	aes(x = date, 
		y = value,
		group = listing_id,
...
cluster_models$kclust[[5]] %>% glance()
...
# If you have the data that you think you need, spend 30 minutes attempting your analysis. If you don't, spend 10 minutes describing how you would go about collecting the necessary data, and 20 minutes trying something out with the data you have. 
